        ...
        <nav className="bg-violet-500 h-screen w-52">
            ...
            <div className="flex justify-center mt-0">
                ...
                <ul className="mt-5">
                    ...
                    >
                        <LuWallet className="mr-5 h-5 w-5" />
                        <span>Tu dinero</span>
                    </Link>
                    ...
                    >
                        <RxActivityLog className="mr-5 h-5 w-5" />
                    ...
                    >
                        <MdOutlineAttachMoney className="mr-5 h-6 w-6" />
                        <span>Pagar</span>
                    </Link>
                    ...
                    >
                        <FaMoneyBillTransfer className="mr-5 h-5 w-5" />
                    ...
                    >
                        <FaListCheck className="mr-5 h-5 w-5" />
                        <span>Lista de empleados</span>
                    </Link>
                    <div className="border-t border-white my-4 mx-4"></div>
                    <Link to='/' className={`flex items-center mt-4 block py-2 px-4 text-white hover:bg-indigo-500 ${active === '/' && 'bg-indigo-700'}`}
                        onClick={() => handleActive('/')}
                    >
                        <LuLogOut  className="mr-5 h-6 w-6" />
